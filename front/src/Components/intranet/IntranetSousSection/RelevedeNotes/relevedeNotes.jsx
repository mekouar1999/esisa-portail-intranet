        ...
        <ul className="semester-list">
          <li className="semester">
            <img
              src={logoReleve}
              alt="Relevé de notes"
              className="semester-image imgg"
            />
            <a
              href="/releve-note-annee-1-semestre-1.pdf"
          ...
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-1-semestre-2.pdf"
              className="download-link-releve"
              download
            >
      ...
      <div className="year">
        ...
        <ul className="semester-list">
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-2-semestre-1.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 1
          ...
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-2-semestre-2.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 2
      ...
      <div className="year">
        ...
        <ul className="semester-list">
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-3-semestre-1.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 1
          ...
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-3-semestre-2.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 2
      ...
      <div className="year">
        ...
        <ul className="semester-list">
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-4-semestre-1.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 1
          ...
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-4-semestre-2.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 2
      ...
      <div className="year">
        ...
        <ul className="semester-list">
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-5-semestre-1.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 1
          ...
          <li className="semester">
            ...
            />
            <a
              href="/releve-note-annee-5-semestre-2.pdf"
              className="download-link-releve"
              download
            >
              Relevé de notes - Semestre 2
